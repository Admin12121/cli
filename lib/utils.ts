...
export function constructMetadata({
  title = "Vicky UI - Modern React + Tailwind CSS components & Templates",
  description = "Vicky UI is a curated collection of the best landing page components built using React + Tailwind CSS + Framer Motion",

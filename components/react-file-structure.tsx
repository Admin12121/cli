...
export function ReactFileTreeDemo() {
  return (
    <div className="relative flex h-[450px] w-1/2 flex-col items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
      ...
      >
        ...
        <Folder value="2" element="src">
          <Folder value="3" element="api"></Folder>
          <Folder value="4" element="components">
            <Folder value="5" element="forms">
              <Folder value="6" element="sign-in">
                <File value="7">
                  <p>index.tsx</p>
                </File>
              </Folder>
              <Folder value="8" element="sign-up">
                <File value="9">
                  <p>index.tsx</p>
                </File>
              </Folder>
            </Folder>
            <Folder value="10" element="global">
              <Folder value="11" element="accordion">
                <File value="12">
                  <p>index.tsx</p>
                </File>
              </Folder>
              <Folder value="13" element="backdrop-gradient">
                <File value="14">
                  <p>index.tsx</p>
                </File>
              </Folder>
              <Folder value="15" element="copy-button">
                <File value="16">
                  <p>index.tsx</p>
                </File>
              </Folder>
              <Folder value="17" element="drop-down">
                <File value="18">
                  <p>index.tsx</p>
                </File>
              </Folder>
              <Folder value="19" element="flip-link">
                <File value="24">
                  <p>index.ts</p>
                </File>
              </Folder>
              <Folder value="21" element="grid-pattern">
                <File value="22">
                  <p>index.tsx</p>
                </File>
              </Folder>
              <Folder value="23" element="particles">
                <File value="24">
                  <p>index.tsx</p>
                </File>
              </Folder>
              <Folder value="25" element="rich-text-editor">
                <File value="26">
              ...
              <Folder value="32" element="skeleton">
                <File value="33">
                  <p>index.tsx</p>
                </File>
              </Folder>
              <Folder value="34" element="glass-sheet">
                <File value="35">
                  <p>index.tsx</p>
                </File>
              </Folder>
              <Folder value="36" element="search">
                <File value="37">
                  <p>index.tsx</p>
                </File>
                <File value="38">
              ...
              <Folder value="39" element="user-widget">
                <File value="40">
                  <p>index.tsx</p>
                </File>
                <File value="41">
              ...
              <Folder value="42" element="glass-card">
                <File value="43">
                  <p>index.tsx</p>
                </File>
              </Folder>
              <Folder value="44" element="form-generator">
                <File value="45">
                  <p>index.tsx</p>
                </File>
              </Folder>
          ...
          <Folder value="88" element="pages">
            <Folder value="88" element="dashboard">
              <File value="89">
                <p>index.tsx</p>
              </File>
            </Folder>
            <Folder value="88" element="empty">
              <File value="89">
                <p>index.tsx</p>
              </File>
            </Folder>
            <Folder value="88" element="home">
              <File value="89">
                <p>index.tsx</p>
              </File>
            </Folder>
